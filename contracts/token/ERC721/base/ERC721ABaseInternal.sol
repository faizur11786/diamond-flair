...
import "../extensions/supply/storage/ERC721SupplyStorage.sol";
import "./interfaces/IERC721AInternal.sol";
...
contract ERC721ABaseInternal is IERC721AInternal, Context {
    ...
    function _setApprovalForAll(
        ...
        ERC721AStorage.layout()._operatorApprovals[_msgSender()][
            operator
        ] = approved;
    ...
    function _transferFrom(
        ...
        if (!_isSenderApprovedOrOwner(approvedAddress, from, _msgSender()))
            if (!_isApprovedForAll(from, _msgSender()))
        ...
        unchecked {
            ...
            if (prevOwnershipPacked & _BITMASK_NEXT_INITIALIZED == 0) {
                ...
                if (
                    ...
                    if (
                        nextTokenId != ERC721SupplyStorage.layout().currentIndex
                    ) {
