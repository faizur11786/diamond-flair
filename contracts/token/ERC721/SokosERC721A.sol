    ...
    ERC721ARoyaltyEnforcementExtension
{
    function _msgSender()
        ...
        view
        virtual
        override(Context, ERC721ABaseERC2771)
        returns (address)
    {
    ...
    function setApprovalForAll(
        ...
        ERC721ARoyaltyEnforcementExtension.setApprovalForAll(
            operator,
            approved
        );
    }
    ...
    function safeTransferFrom(
        ...
        ERC721ARoyaltyEnforcementExtension.safeTransferFrom(
            from,
            to,
            tokenId,
            data
