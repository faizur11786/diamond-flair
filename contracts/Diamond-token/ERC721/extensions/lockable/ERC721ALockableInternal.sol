...
import "./storage/ERC721LockableStorage.sol";
import "./interfaces/IERC721LockableInternal.sol";

abstract contract ERC721ALockableInternal is
    IERC721LockableInternal,
    ERC721ABaseInternal
{
